...
pub struct MarkdownPreviewSettingsContent {
    ...
    /// Which side of the markdown preview to show the table of contents drawer
    /// on.
    ///
    /// Default: left
    pub table_of_contents_position: Option<MarkdownPreviewTableOfContentsPosition>,
}
...
#[serde(rename_all = "snake_case")]
pub enum MarkdownPreviewTableOfContentsPosition {
    /// Show the table of contents drawer on the left side.
    #[default]
    Left,
    /// Show the table of contents drawer on the right side.
    Right,
}
