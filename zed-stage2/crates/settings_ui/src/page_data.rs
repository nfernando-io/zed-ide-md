...
fn language_settings_data() -> Box<[SettingsPageItem]> {
    ...
    fn global_only_miscellaneous_sub_section() -> [SettingsPageItem; 5] {
        [
            SettingsPageItem::SettingItem(SettingItem {
                title: "Image Viewer",
            ...
            SettingsPageItem::SettingItem(SettingItem {
                files: USER,
                title: "Markdown Preview Table Of Contents Position",
                description: "Which side of the markdown preview to show the table of contents drawer on.",
                field: Box::new(SettingField {
                    organization_override: None,
                    json_path: Some("markdown_preview.table_of_contents_position"),
                    pick: |settings_content| {
                        settings_content
                            .markdown_preview
                            .as_ref()?
                    ...
                    write: |settings_content, value, _| {
                        settings_content
                            .markdown_preview
                            .get_or_insert_default()
                            .table_of_contents_position = value;
                    },
                }),
                metadata: None,
            }),
