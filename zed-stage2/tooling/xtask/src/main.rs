...
enum CliCommand {
    ...
    /// Runs Stage 2 Markdown preview development tasks.
    MarkdownPreview(tasks::markdown_preview::MarkdownPreviewArgs),
...
fn main() -> Result<()> {
    ...
    match args.command {
        ...
        CliCommand::MarkdownPreview(args) => tasks::markdown_preview::run_markdown_preview(args),
